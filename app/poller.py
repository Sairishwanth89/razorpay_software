...
from app.agents.detector import poll_abandoned_orders, poll_overdue_invoices
...
async def poller_loop() -> None:
    while True:
        try:
            ...
            candidates += await asyncio.wait_for(asyncio.to_thread(poll_overdue_invoices), timeout=30)
